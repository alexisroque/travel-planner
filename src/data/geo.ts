...
export const dayEnrich: Record<string, Enrich> = {
  ...
  d2: {
    ...
    stops: [
      ...
      { n: 4, name: 'Sentosa — Playa Palawan', category: 'Playa', emoji: '🏖️', alt: 'A', coords: { lat: 1.2496, lon: 103.8226 }, time: '13:30', note: 'Agua calmada, hamacas, puente al islote y cable car con vistas. El plan al aire libre.',
        transitToNext: { mode: 'train', min: 30, note: 'Vuelta a Gardens by the Bay' } },
      { n: 5, name: 'S.E.A. Aquarium / Universal Studios', category: 'Naturaleza', emoji: '🐠', alt: 'B', coords: { lat: 1.2580, lon: 103.8208 }, time: '13:30', hours: 'Acuario ~30€ · Universal ~55€', note: 'Plan cubierto para el calor/lluvia, en la misma Sentosa: acuario gigante con túnel de tiburones, o un día de atracciones en Universal si preferís adrenalina.',
        transitToNext: { mode: 'train', min: 30, note: 'Vuelta a Gardens by the Bay' } },
      { n: 6, name: 'OCBC Skyway (Supertrees)', category: 'Mirador', emoji: '🌉', coords: { lat: 1.2825, lon: 103.8640 }, time: '18:45', hours: '~10 SGD', note: 'Pasarela a 22m entre los Supertrees al atardecer (~19:11). Cena rápida en Satay by the Bay antes.',
        transitToNext: { mode: 'walk', min: 3 } },
      { n: 7, name: 'Garden Rhapsody — show de luz', category: 'Show', emoji: '🌳', coords: { lat: 1.2820, lon: 103.8645 }, time: '19:45', hours: 'Gratis · 19:45 y 20:45', note: 'Luz y sonido bajo los Supertrees, tumbados en el césped. Cierre perfecto de Singapur.' },
    ],
  },
  ...
  d12: {
    ...
    stops: [
      ...
      { n: 3, name: 'KLIA2', category: 'Aeropuerto', emoji: '🛫', coords: { lat: 2.7456, lon: 101.6865 }, time: '13:50', note: 'Facturar AK398. Vuelo 16:05.',
        transitToNext: { mode: 'flight', min: 190, note: 'AK398 KUL→DPS 16:05' } },
  ...
  d15: {
    ...
    stops: [
      ...
      { n: 2, name: 'Puerto Padang Bai', category: 'Puerto', emoji: '⚓', coords: { lat: -8.5300, lon: 115.5100 }, time: '08:30', note: 'Embarque del fast boat. Antimareos 30 min antes.',
        transitToNext: { mode: 'ferry', min: 180, note: 'Barco 09:00 · Padang Bai→Gili Air' } },
  ...
  d17: {
    ...
    stops: [
      { n: 1, name: 'Desayuno + embarcadero Gili Air', category: 'Puerto', emoji: '⚓', coords: { lat: -8.3620, lon: 116.0790 }, time: '07:30', note: 'Desayuno temprano, check-out y al muelle (cidomo con maletas).',
        transitToNext: { mode: 'ferry', min: 105, note: 'Fast boat 08:30 · Gili Air→Sanur' } },
  ...
  d23: {
    ...
    stops: [
      ...
      { n: 2, name: 'Aeropuerto DPS — comida', category: 'Aeropuerto', emoji: '🛫', coords: { lat: -8.7467, lon: 115.1668 }, time: '12:00', note: 'Comer en Ngurah Rai antes del vuelo Scoot TR289 (14:05).',
        transitToNext: { mode: 'flight', min: 170, note: 'TR289 14:05 · DPS→SIN' } },
